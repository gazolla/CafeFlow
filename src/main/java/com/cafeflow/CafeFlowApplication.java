...
public class CafeFlowApplication {
    ...
    @Bean
    public CommandLineRunner scheduleRunner(io.temporal.client.schedules.ScheduleClient scheduleClient) {
        return args -> {
            ...
            try {
                    ...
                    io.temporal.client.schedules.ScheduleSpec.newBuilder()
                        .setCalendars(java.util.Collections.singletonList(
                            io.temporal.client.schedules.ScheduleCalendarSpec.newBuilder()
                                .setHour(java.util.Collections.singletonList(new io.temporal.client.schedules.ScheduleRange(8)))
                                .setMinute(java.util.Collections.singletonList(new io.temporal.client.schedules.ScheduleRange(0)))
                                .build()
                        ))
                        .build();
                ...
                scheduleClient.createSchedule(scheduleId, schedule, io.temporal.client.schedules.ScheduleOptions.newBuilder().build());
